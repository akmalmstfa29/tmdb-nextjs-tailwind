  ...
  return (
    <div className='relative'>
      <form onSubmit={handleSubmit}>
        ...
        <input
          className='flex h-9 pr-14 pl-10 text-sm text-slate-400 bg-transparent rounded-md border border-slate-400 focus:outline-none focus:border-1 focus:border-solid focus:border-slate-300 hover:slate-shadow-soft duration-200'
          type='text'
