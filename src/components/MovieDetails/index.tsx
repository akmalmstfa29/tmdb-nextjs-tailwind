  ...
  return (
    <div className='relative animate-fadeIn'>
      ...
      <div className='relative w-full pt-80 pb-64 px-4 md:px-8'>
        ...
        <h2 className='text-white text-4xl md:text-5xl md:max-w-[70%] xl:text-6xl font-bold text-shadow-md uppercase tracking-wide my-3'>
          {title}
        </h2>
        ...
        <div>
          <h3 className='text-neutral-400 mt-6 text-xl font-bold'>Director{directors.length > 1 ? 's' : ''}</h3>
          <div>
